...
class RandomName {
    ...
    public static function Full()
    {
        ...
        if ($female)
        {
            array_push($randomName, static::$femaleNameList[array_rand(static::$femaleNameList)]);
        }
        else
        {
            array_push($randomName, static::$maleNameList[array_rand(static::$maleNameList)]);
        }
        array_push($randomName, static::$surnameList[array_rand(static::$surnameList)]);
        return implode(' ', $randomName);
    }
    public static function Male()
    {
        return static::$maleNameList[array_rand(static::$maleNameList)];
    }
    public static function Female()
    {
        return static::$femaleNameList[array_rand(static::$femaleNameList)];
    }
    public static function Surname()
    {
        return static::$surnameList[array_rand(static::$surnameList)];
    }
}
